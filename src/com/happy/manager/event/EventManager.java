...
public class EventManager {
    ...
    public String deleteEvent(@Context UriInfo info) {
        final EventHappy eventHappy = new EventHappy.Builder(Integer.parseInt(info.getQueryParameters().getFirst("id")),info.getQueryParameters().getFirst("type"), info.getQueryParameters().getFirst("comment")).build();
