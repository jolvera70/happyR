 ...
 */
public final class ListNameCache {
    @Override
    public boolean equals(Object o) {
        if (this == o) return true;
        if (o == null || getClass() != o.getClass()) return false;

        ListNameCache that = (ListNameCache) o;
    ...
    private ListNameCache(final String name) {
        this.name = name;
    }

    public static ListNameCache createNewInstance(String name){
        return new ListNameCache(name);
    }

    private static final Map<String, String> map = new HashMap<String, String>();

    protected static void showAllNames() {
        System.out.println(map);
    }

    protected String encryptingName() {
        try {
